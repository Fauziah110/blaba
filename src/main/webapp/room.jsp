...
<body>
	...
	<table>
			...
			<div class="modal-content">
				...
				<form action="Room.jsp" method="post">
					...
					<label for="roomId">No Room:</label> <input type="text" id="roomId"
						name="roomId" required><br> <label for="roomType">Type
						Room:</label> <select id="roomType" name="roomType">
		...
		if ("POST".equalsIgnoreCase(request.getMethod())) {
			...
			int staffInCharge = Integer.parseInt(request.getParameter("staffInCharge")); // Correct variable name
			...
			try {
				...
				ps2.setString(3, roomStatus);
				ps2.setDouble(4, roomPrice);
				ps2.setInt(5, staffInCharge); // Insert staffid, not staffName
